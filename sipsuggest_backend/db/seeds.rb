...
cola = Ingredient.find_or_create_by(name: 'Cola')
RecipeIngredient.create(recipe: long_island_iced_tea, ingredient: cola, quantity: '1 dash ')
lemon_peel = Ingredient.find_or_create_by(name: 'Lemon Peel')
...
gin_basil_smash = Recipe.create(name: 'Gin Basil Smash', description: 'Placeholder', img_link:'nil')

gin = Ingredient.find_or_create_by(name: 'Gin')
RecipeIngredient.create(recipe: gin_basil_smash, ingredient: gin, quantity: '6 cl')
lemon_juice = Ingredient.find_or_create_by(name: 'Lemon Juice')
RecipeIngredient.create(recipe: gin_basil_smash, ingredient: lemon_juice, quantity: '2 cl')
sugar_syrup = Ingredient.find_or_create_by(name: 'Sugar Syrup')
RecipeIngredient.create(recipe: gin_basil_smash, ingredient: sugar_syrup, quantity: '2 cl')
basil = Ingredient.find_or_create_by(name: 'Basil')
RecipeIngredient.create(recipe: gin_basil_smash, ingredient: basil, quantity: 'Whole')

Step.create(recipe: gin_basil_smash, step_number: 1, instruction: 'Muddle Basil leaves (~ 10) with Suggar Syrup in a shaker')
Step.create(recipe: gin_basil_smash, step_number: 2, instruction: ' Add Gin an Lemon Juice')

the_last_word = Recipe.create(name: 'The Last Word', description: 'Placeholder', img_link:'nil')

green_chartreuse = Ingredient.find_or_create_by(name: 'Green Chartreuse')
RecipeIngredient.create(recipe: the_last_word, ingredient: green_chartreuse, quantity: '1 oz')
maraschino_liqueur = Ingredient.find_or_create_by(name: 'Maraschino Liqueur')
RecipeIngredient.create(recipe: the_last_word, ingredient: maraschino_liqueur, quantity: '1 oz')
lime_juice = Ingredient.find_or_create_by(name: 'Lime Juice')
RecipeIngredient.create(recipe: the_last_word, ingredient: lime_juice, quantity: '1 oz')
gin = Ingredient.find_or_create_by(name: 'Gin')
RecipeIngredient.create(recipe: the_last_word, ingredient: gin, quantity: '1 oz')

Step.create(recipe: the_last_word, step_number: 1, instruction: 'Shake with ice and strain into a cocktail glass')

tommy_margarita = Recipe.create(name: "Tommy's Margarita", description: 'Placeholder', img_link:'nil')

tequila = Ingredient.find_or_create_by(name: 'Tequila')
RecipeIngredient.create(recipe: tommy_margarita, ingredient: tequila, quantity: '4.5 cl')
lime_juice = Ingredient.find_or_create_by(name: 'Lime Juice')
RecipeIngredient.create(recipe: tommy_margarita, ingredient: lime_juice, quantity: '1.5 cl')
agave_syrup = Ingredient.find_or_create_by(name: 'Agave Syrup')
RecipeIngredient.create(recipe: tommy_margarita, ingredient: agave_syrup, quantity: '2 spoons')

Step.create(recipe: tommy_margarita, step_number: 1, instruction: 'Shake and strain into a chilled cocktail glass')

godfather = Recipe.create(name: 'Godfather', description: 'Placeholder', img_link:'https://www.thecocktaildb.com/images/media/drink/e5zgao1582582378.jpg')

scotch = Ingredient.find_or_create_by(name: 'Scotch')
RecipeIngredient.create(recipe: godfather, ingredient: scotch, quantity: '1 1/2 oz ')
amaretto = Ingredient.find_or_create_by(name: 'Amaretto')
RecipeIngredient.create(recipe: godfather, ingredient: amaretto, quantity: '3/4 oz ')

Step.create(recipe: godfather, step_number: 1, instruction: 'Pour all ingredients directly into old fashioned glass filled with ice cubes')
Step.create(recipe: godfather, step_number: 2, instruction: ' Stir gently')

alabama_slammer = Recipe.create(name: 'Alabama Slammer', description: 'Placeholder', img_link:'https://www.thecocktaildb.com/images/media/drink/jntghf1606771886.jpg')

southern_comfort = Ingredient.find_or_create_by(name: 'Southern Comfort')
RecipeIngredient.create(recipe: alabama_slammer, ingredient: southern_comfort, quantity: '1 oz ')
amaretto = Ingredient.find_or_create_by(name: 'Amaretto')
RecipeIngredient.create(recipe: alabama_slammer, ingredient: amaretto, quantity: '1 oz ')
sloe_gin = Ingredient.find_or_create_by(name: 'Sloe Gin')
RecipeIngredient.create(recipe: alabama_slammer, ingredient: sloe_gin, quantity: '1/2 oz ')
lemon_juice = Ingredient.find_or_create_by(name: 'Lemon Juice')
RecipeIngredient.create(recipe: alabama_slammer, ingredient: lemon_juice, quantity: '1 dash ')

Step.create(recipe: alabama_slammer, step_number: 1, instruction: 'Pour all ingredients (except for lemon juice) over ice in a highball glass')
Step.create(recipe: alabama_slammer, step_number: 2, instruction: ' Stir, add a dash of lemon juice, and serve')

bahama_mama = Recipe.create(name: 'Bahama Mama', description: 'Placeholder', img_link:'nil')

rum = Ingredient.find_or_create_by(name: 'Rum')
RecipeIngredient.create(recipe: bahama_mama, ingredient: rum, quantity: '3 parts')
dark_rum = Ingredient.find_or_create_by(name: 'Dark Rum')
RecipeIngredient.create(recipe: bahama_mama, ingredient: dark_rum, quantity: '1 part')
banana_liqueur = Ingredient.find_or_create_by(name: 'Banana Liqueur')
RecipeIngredient.create(recipe: bahama_mama, ingredient: banana_liqueur, quantity: '1 part')
grenadine = Ingredient.find_or_create_by(name: 'Grenadine')
RecipeIngredient.create(recipe: bahama_mama, ingredient: grenadine, quantity: '1 part')
pineapple_juice = Ingredient.find_or_create_by(name: 'Pineapple Juice')
RecipeIngredient.create(recipe: bahama_mama, ingredient: pineapple_juice, quantity: '2 parts')
orange_juice = Ingredient.find_or_create_by(name: 'Orange Juice')
RecipeIngredient.create(recipe: bahama_mama, ingredient: orange_juice, quantity: '2 parts')
sweet_and_sour = Ingredient.find_or_create_by(name: 'Sweet And Sour')
RecipeIngredient.create(recipe: bahama_mama, ingredient: sweet_and_sour, quantity: '1 part')

Step.create(recipe: bahama_mama, step_number: 1, instruction: 'Add 2 parts club soda or more or less to taste')
Step.create(recipe: bahama_mama, step_number: 2, instruction: 'Mix it all together and pour over a bunch of ice')
Step.create(recipe: bahama_mama, step_number: 3, instruction: ' Drink with a straw')

gin_and_tonic = Recipe.create(name: 'Gin And Tonic', description: 'Placeholder', img_link:'https://www.thecocktaildb.com/images/media/drink/k0508k1668422436.jpg')

gin = Ingredient.find_or_create_by(name: 'Gin')
RecipeIngredient.create(recipe: gin_and_tonic, ingredient: gin, quantity: '2 oz ')
tonic_water = Ingredient.find_or_create_by(name: 'Tonic Water')
RecipeIngredient.create(recipe: gin_and_tonic, ingredient: tonic_water, quantity: '5 oz ')
lime = Ingredient.find_or_create_by(name: 'Lime')
RecipeIngredient.create(recipe: gin_and_tonic, ingredient: lime, quantity: '1 ')

Step.create(recipe: gin_and_tonic, step_number: 1, instruction: 'Pour the gin and the tonic water into a highball glass almost filled with ice cubes')
Step.create(recipe: gin_and_tonic, step_number: 2, instruction: ' Stir well')
Step.create(recipe: gin_and_tonic, step_number: 3, instruction: ' Garnish with the lime wedge')
